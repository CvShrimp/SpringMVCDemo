package com.cvshrimp.mvcdemo.service.impl;
...
import com.cvshrimp.mvcdemo.model.Chapter;
...
public class CourseServiceImpl implements CourseService{
	...
	public Course getCourseById(Integer courseId) {
		...
		course.setDuration(72001);
		course.setDesc("You will know how the java-thread works.");
	...
	private void wrapChapterList(Integer courseId, List<Chapter> chapterList)
	{
		...
		chapter.setDesc("Java语言层面对线程的支持，如何创建，启动和停止线程。如何使用常用的线程方法。用隋唐演义理解线程的代码");
		chapterList.add(chapter);
		...
		chapter.setDesc("本章讨论如何正确的停止一个线程，既要线程停得了，还得线程停得好。");		
		chapterList.add(chapter);
		...
		chapter.setDesc("争用条件，线程的交互，及死锁的成因及预防。");		
		chapterList.add(chapter);
		...
		chapter.setDesc("简单介绍 Java 并发相关的类，及常用的多线程编程模型。");		
		chapterList.add(chapter);		
	}
}
